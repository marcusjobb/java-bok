...
If-satser används i många olika situationer och scenarier inom programmering. Här är några exempel på användningsområden för if-satser i Java:
