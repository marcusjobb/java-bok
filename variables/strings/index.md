...
Att arbeta med strängar är mer än att bara skriva

```java
System.out.println("Läraren "+ name + " är " + age + " år gammal");
```

Men det gör koden ganska ful om vi ska vara ärliga, så nu ska vi kolla på hur vi kan göra det snyggare.
